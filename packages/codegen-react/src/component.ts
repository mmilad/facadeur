...
function variantTypeSpecs(document: DocumentFile, entry: CatalogEntry): VariantTypeSpec[] {
...
function assertDefault(documentId: string, field: FieldDefinition, value: FieldValue): void {
  const matches =
    field.type === 'boolean'
...
function printElement(element: ElementNode, indent: number): string {
...
function jsLiteral(value: FieldValue): string {
